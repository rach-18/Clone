    ...
    <>
      ...
      <div className="w-full bg-[#F6F6F6] rounded-lg p-5 mt-2 shadow-md">
        {passengerDetails.passengers.map((passenger, index) => {
          return (
            <div key={index} className="flex md:flex-row flex-col md:gap-0 gap-2 justify-between items-center">
              <div className="w-full flex itmes-center md:justify-between mx-8">
        ...
        <div className="flex md:flex-row flex-col md:items-center mt-4">
          <div className="md:w-1/3 w-full flex itmes-center md:justify-between md:mx-8">
